...
class LocalAuthModule extends AbstractAuthModule {
  ...
  async inviteHandler(req, res, next) {
    try {
      ...
      const html = `<h2>You're almost ready</h2><p>Someone has set you up with a new Adapt account. Please use the link below to create a new password and finish setting up your account:</p><p><a href="{{url}}">Set your Adapt password</a></p>`;
