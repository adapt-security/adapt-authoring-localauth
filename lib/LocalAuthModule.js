...
class LocalAuthModule extends AbstractAuthModule {
  ...
  async updateUser(req, userIdOrQuery, updateData) {
    ...
    const subject = this.app.lang.translate(req, 'app.updateusersubject');
    const text = this.app.lang.translate(req, 'app.updateusertext');
    const html = this.app.lang.translate(req, 'app.updateuserhtml');
  ...
  async inviteHandler(req, res, next) {
    try {
      ...
      const subject = this.app.lang.translate(req, 'app.invitepasswordsubject');
      const text = this.app.lang.translate(req, 'app.invitepasswordtext');
      const html = this.app.lang.translate(req, 'app.invitepasswordhtml');
  ...
  async forgotPasswordHandler(req, res, next) {
    try {
      const { email } = req.body;
      const subject = this.app.lang.translate(req, 'app.forgotpasswordsubject');
      const text = this.app.lang.translate(req, 'app.forgotpasswordtext');
      const html = this.app.lang.translate(req, 'app.forgotpasswordhtml');
      await this.createPasswordReset(email, subject, text, html);
