...
class LocalAuthModule extends AbstractAuthModule {
  ...
  async validatePassword(password) {
    ...
    const validationChecks = {
      INVALID_PASSWORD_LENGTH: password.length >= this.getConfig('minPasswordLength'),
    ...
    const errors = Object.entries(validationChecks).reduce((m, [code, isValid]) => isValid ? m : [...m, this.app.errors[code]], []);
